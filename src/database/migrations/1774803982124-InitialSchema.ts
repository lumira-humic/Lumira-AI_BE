...
export class InitialSchema1774803982124 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."chat_messages_sender_type_enum" AS ENUM('doctor', 'patient')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_7971b21fbbccd1d5e5a0cceacb" ON "chat_messages" ("is_read") `);
        await queryRunner.query(`CREATE INDEX "IDX_32474621b071f82da3127a6af5" ON "chat_messages" ("patient_id", "doctor_id") `);
        ...
        await queryRunner.query(`CREATE TYPE "public"."medical_records_validation_status_enum" AS ENUM('PENDING', 'APPROVED', 'REJECTED', 'REVIEWED')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_000a7d3138cce07f568220a320" ON "medical_records" ("validator_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_1f6da7541d693448c96c11cc34" ON "medical_records" ("validation_status") `);
        await queryRunner.query(`CREATE INDEX "IDX_43e2800e756c913a6c7a07cc27" ON "medical_records" ("patient_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "role" "public"."users_role_enum" NOT NULL DEFAULT 'doctor'`);
        ...
        await queryRunner.query(`ALTER TABLE "chat_messages" ADD CONSTRAINT "FK_f402cd3849b3dfc50a9dad9a678" FOREIGN KEY ("patient_id") REFERENCES "patients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chat_messages" ADD CONSTRAINT "FK_adc90ff9631a4f567b7d45364c0" FOREIGN KEY ("doctor_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "medical_records" ADD CONSTRAINT "FK_43e2800e756c913a6c7a07cc271" FOREIGN KEY ("patient_id") REFERENCES "patients"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "medical_records" ADD CONSTRAINT "FK_000a7d3138cce07f568220a3208" FOREIGN KEY ("validator_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "medical_records" DROP CONSTRAINT "FK_000a7d3138cce07f568220a3208"`);
        await queryRunner.query(`ALTER TABLE "medical_records" DROP CONSTRAINT "FK_43e2800e756c913a6c7a07cc271"`);
        await queryRunner.query(`ALTER TABLE "chat_messages" DROP CONSTRAINT "FK_adc90ff9631a4f567b7d45364c0"`);
        await queryRunner.query(`ALTER TABLE "chat_messages" DROP CONSTRAINT "FK_f402cd3849b3dfc50a9dad9a678"`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN "id"`);
